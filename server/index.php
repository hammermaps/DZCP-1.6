                    ...
                    if (is_null($CachedString->get()) || isset($_GET['cID'])) {
                        ...
                        if (empty($player_list)) {
                            ...
                            foreach ($player_list as $key => $player) {
                                ...
                                if ($score == 1) {
                                    $colspan++;
                                    $show_score = '<td class="' . $class . '" align="center">' . $player['score'] . '</td>';
                                } else             $show_score = '';
                                if ($deaths == 1) {
                                    $colspan++;
                                    $show_deaths = '<td class="' . $class . '" align="center">' . $player['deaths'] . '</td>';
                                } else             $show_deaths = '';
                                if ($skill == 1) {
                                    $colspan++;
                                    $show_skill = '<td class="' . $class . '" align="center">' . $player['skill'] . '</td>';
                                } else             $show_skill = '';
                                if ($goal == 1) {
                                    $colspan++;
                                    $show_goal = '<td class="' . $class . '" align="center">' . $player['goal'] . '</td>';
                                } else             $show_goal = '';
                                if ($honor == 1) {
                                    $colspan++;
                                    $show_honor = '<td class="' . $class . '" align="center">' . $player['honor'] . '</td>';
                                } else             $show_honor = '';
                                if ($leader == 1) {
                                    $colspan++;
                                    $show_leader = '<td class="' . $class . '" align="center">' . $player['leader'] . '</td>';
                                } else             $show_leader = '';
                                if ($ping == 1) {
                                    $colspan++;
                                    $show_ping = '<td class="' . $class . '" align="center">' . $player['ping'] . '</td>';
                                } else             $show_ping = '';
                                if ($stats == 1) {
                                    $colspan++;
                                    $show_stats = '<td class="' . $class . '" align="center">' . $player['stats'] . '</td>';
                                } else             $show_stats = '';
                                if ($time == 1) {
                                    $colspan++;
                                    $show_time = '<td class="' . $class . '" align="center">' . $player['time'] . '</td>';
                                } else             $show_time = '';
