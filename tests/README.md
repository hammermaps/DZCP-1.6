...
SQLite integration tests may create temporary databases outside the repository. To initialise the complete local demo database, run `php tools/setup-test-database.php --reset`; its data directory is ignored.
