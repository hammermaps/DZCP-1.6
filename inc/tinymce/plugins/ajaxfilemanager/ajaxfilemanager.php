...
<head>
    ...
    <script type="text/javascript">
        ...
        var paths = {
            'root': '<?php echo addTrailingSlash(backslashToSlash(CONFIG_SYS_ROOT_PATH)); ?>',
            'root_title': '<?php echo LBL_FOLDER_ROOT; ?>'
        };
        var parentFolder = {};
        var urls = {
        ...
        var newFile = {
            'num': 1,
            'label': '<?php echo FILE_LABEL_SELECT; ?>',
            'upload': '<?php echo FILE_LBL_UPLOAD; ?>'
        };
        ...
        $(document).ready(
            function () {
                ...
                $('.inputMtime').calendar({
                    autoPopUp: 'both',
                    buttonImage: 'theme/<?php echo CONFIG_THEME_NAME; ?>/images/date_picker.png'
                });
...
<div id="wrapper">
    <div id="header">
        ...
        <ul id="actionHeader">
            ...
            <li><a href="javascript:window.close()" id="actionClose"
                   onclick="return cancelSelectFile();"><?php echo IMG_BTN_CLOSE; ?></a></li>
        ...
        <form action="" method="post" name="formAction" id="formAction"><input type="hidden" name="currentFolderPath"
                                                                               id="currentFolderPathVal"
                                                                               value=""/><select name="selectedDoc[]"
                                                                                                 id="selectedDoc"
                                                                                                 style="display:none;"
                                                                                                 multiple="multiple"></select><input
                    type="hidden" name="action_value" value="" id="action_value"/></form>
    </div>
                  ...
                  ?></span>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" class="input inputMtime" name="search_mtime_to" id="search_mtime_to"
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="radio" name="search_recursively" value="1" id="search_recursively_1"
                                       class="radio" <?php echo(!empty($_GET['search_recursively']) ? 'checked="checked"' : ''); ?> /> <?php echo LBL_RECURSIVELY_YES; ?>
                                <input type="radio" name="search_recursively" value="0" id="search_recursively_0"
                                       class="radio" <?php echo(empty($_GET['search_recursively']) ? 'checked="checked"' : ''); ?> /> <?php echo LBL_RECURSIVELY_NO; ?>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="1%" nowrap style="padding-right:16px;">
                                <a href="#" onclick="return searchDocuments();"
                                   class="buttonLink"><span><?php echo BTN_SEARCH; ?></span></a>
            ...
            <fieldset id="folderFieldSet">
                ...
                <table cellpadding="0" cellspacing="0" class="tableSummary" id="folderInfo">
                    ...
                    <tr>
                        ...
                        <td colspan="3"
                            id="folderCtime"><?php echo(!empty($folderInfo['ctime']) ? date(DATE_TIME_FORMAT, $folderInfo['ctime']) : '&nbsp;'); ?></td>

                    </tr>
                    <tr>
                        <th><?php echo LBL_FOLDER_MODIFIED; ?></th>
                        <td colspan="3"
                            id="folderMtime"><?php echo(!empty($folderInfo['mtime']) ? date(DATE_TIME_FORMAT, $folderInfo['mtime']) : '&nbsp;'); ?></td>
                    </tr>
                    <tr>
...
<div id="ajaxLoading" style="display:none"><img class="ajaxLoadingImg"
        ...
        <div class="jqmBody">
            <form id="formUpload" name="formUpload" method="post" enctype="multipart/form-data" action="">
                <table class="tableForm" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <th colspan="4"><?php echo FILE_FORM_TITLE; ?><a class="action" href="#"
                                                                         title="<?php echo FILE_LBL_MORE; ?>"
                                                                         onclick="return addMoreFile();"><span
                                        class="addMore">&nbsp;</span></a></th>
                    </tr>
                    </thead>
                    ...
                    <tr style="display:none">
                        ...
                        <td><a href="#" class="action" title="Cancel" style="display:none"><span
                                        class="cancel">&nbsp;</span></a> <span class="uploadProcessing"
            ...
            <form id="formNewFolder" name="formNewFolder" method="post" action="">
                ...
                <table class="tableForm" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="new_folder" style="font-size:12px" id="new_folder" value=""
                                   class="input"></td>
                    </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td nowrap width="1%"><a href="#" class="buttonLink"
                                                             onclick="return doCreateFolder();"><span><?php echo FOLDER_LBL_CREATE; ?></span></a>
                                    </td>
                                </tr>
                            </table>
            ...
            <form id="formRename" name="formRename" method="post" action="">
                ...
                <table class="tableForm" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="name" id="renameName" style="font-size:12px" class="input" name="name"
                                   style="width:250px"/>
                        </td>
                    </tr>
                    </tbody>
                        ...
                        <td nowrap>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="99%">&nbsp;</td>
                                    <td nowrap width="1%"><a href="#" class="buttonLink"
                                                             onclick="return doRename();"><span><?php echo RENAME_LBL_RENAME; ?></span></a>
                                    </td>
                                </tr>
                            </table>
            ...
            <table class="tableInfo" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        make changes to it, in order to avoid any Legal Issues. We also offer website development
                        service, please contact us at <a
