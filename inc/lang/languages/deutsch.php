...
$language_text['_addoncheck_addon'] = 'Erweiterung';
...
$language_text['_addoncheck_yourversion'] = 'Ihre Version';
$language_text['_addoncheck_currVersion'] = 'Neuste Version';
$language_text['_addoncheck_VersionOK'] = 'Version ist Aktuell';
$language_text['_addoncheck_notinstalled'] = 'Nicht installiert';
$language_text['_addoncheck_checkDisabled'] = 'Fehler beim abrufen der aktuellen Version';
...
$language_text['_datenschutz_settings_lock_head'] = 'Einstellungen der EU-DSGVO f&uuml;r die Account-Aktivierung';
...
$language_text['_datenschutz_rolle_1'] = 'Hauptverantwortlicher ( <span style="color:#FF0000">*Ben&ouml;tigt*</span> )';
...
$language_text['_admin_dsgvo_indent_lock'] = 'Account ist aufgrund der EU-DSGVO gesperrt, du kannst die Identit&auml;t des Users nicht annehmen!';
$language_text['_dsgvo_deleted_text'] = '<span style="color:#999999;">-- Der Autor dieses Posts hat den Text gel&ouml;scht --</span>';
$language_text['_dsgvo_locked_text'] = '<span style="color:#999999;">-- Der Account ist aufgrund der EU-DSGVO gesperrt --</span>';
$language_text['_profil_del_account_full'] = 'Account vollst&auml;ndig l&ouml;schen';
$language_text['_profil_del_account_head'] = 'Account l&ouml;schen';
...
$language_text['_txt_navi_server'] = 'Servernavigation';
...
$language_text['_txt_random_gallery'] = 'zuf&auml;lliges Galleriebild';
...
$language_text['_gal_pics'] = 'Bilder in Gallerie';
$language_text['_config_slideshow'] = 'Slideshow';
$language_text['_perm_slideshow'] = 'Slideshow-Bilder verwalten';
$language_text['_slider'] = 'Slideshow';
$language_text['_slider_admin_add'] = 'Neues Slideshowbild hinzuf&uuml;gen';
$language_text['_slider_admin_add_done'] = 'Das Slideshowbild wurde erfolgreich eingef&uuml;gt';
$language_text['_slider_admin_del'] = 'Soll das Slideshowbild wirklich gel&ouml;scht werden';
$language_text['_slider_admin_del_done'] = 'Das Slideshowbild wurde erfolgreich gel&ouml;scht';
$language_text['_slider_admin_edit'] = 'Slideshowbild editieren';
$language_text['_slider_admin_edit_done'] = 'Die &auml;nderungen wurden erfolgreich &uuml;bernommen!';
$language_text['_slider_admin_error_empty_bezeichnung'] = 'Du musst eine Bezeichnung eingeben';
$language_text['_slider_admin_error_empty_url'] = 'Du musst einen Link hinterlegen';
$language_text['_slider_admin_error_nopic'] = 'Du musst ein Bild hochladen';
$language_text['_slider_bezeichnung'] = 'Bezeichnung';
$language_text['_slider_new_window'] = 'Neues Fenster?';
$language_text['_slider_pic'] = 'Bild';
$language_text['_slider_desc'] = 'Beschreibung';
$language_text['_slider_position'] = 'Position';
$language_text['_slider_position_first'] = 'als erstes';
$language_text['_slider_position_lazy'] = '<option value="lazy">- nicht &auml;ndern -</option>';
$language_text['_slider_url'] = 'URL';
$language_text['_slider_show_title'] = 'Title anzeigen';
...
$language_text['_cw_screenshot_deleted'] = 'Screenshot erfolgreich gel&ouml;scht';
$language_text['_perm_galleryintern'] = 'Interne Gallerie einsehen';
...
$language_text['_ts_settings_customicon'] = 'Eigene Icons runterladen';
$language_text['_ts_settings_showchannels'] = 'Nur Channels mit Usern anzeigen';
$language_text['_ts_settings_showchannels_desc'] = 'Wenn dies eingeschaltet ist werden nur Channels angezeigt in denen auch User sind.';
...
$language_text['_dzcp_vcheck'] = 'Der DZCP Versions Checker informiert dich &uuml;ber neue DZCP Updates und zeigt dir, ob deine Version aktuell ist.<br><br><span class=fontBold>Beschreibung:</span><br><span style=color:#17D427>Gr&uuml;n:</span>Up to Date!<br><span style=color:#FFFF00>Gelb:</span> Keine Verbindung zu Server<br><span style=color:#FF0000>Rot:</span> Es ist ein neues Update verf&uuml;gbar<br><span style=color:#7783ff>Enzianblau:</span> Fehler bei der Antwort des API-Servers';
$language_text['_cw_dont_exist'] = 'Die angegebene Clanwar-ID existiert nicht!';
//Steam
$language_text['_steam'] = 'Steam';
$language_text['_steam_online'] = 'Online';
$language_text['_steam_offline'] = 'Zuletzt online: vor [time]';
$language_text['_steam_offline_simple'] = 'Offline.';
$language_text['_steam_in_game'] = 'Im Spiel';
$language_text['_config_steam_apikey'] = 'Steam API-Key';
$language_text['_steam_apikey_info'] = 'Registrierung eines Steam API-Keys: <a href="http://steamcommunity.com/dev/apikey/" target="_blank">steamcommunity.com</a>';
...
$language_text['_perm_editts'] = 'Teamspeak Server verwalten';
...
$language_text['_profil_del_account'] = 'Account teilweise l&ouml;schen';
...
$language_text['_config_gb_activ'] = 'G&auml;stebuch';
$language_text['_config_gb_activ_info'] = '<div style="text-align:center;">Definiert, ob ein Eintrag zun&auml;chst von einem Admin freigegeben werden muss.</div>';
...
$language_text['_config_cache_info'] = 'Hier k&ouml;nenn die Intervalle festgelegt werden, in der der Teamspeak- oder Gameserver neu abgefragt werden. Darunter werden die Daten aus dem Cache gelesen.';
...
$language_text['_cw_reset_button'] = 'Admin: Spielerstatus zur&uuml;cksetzen';
$language_text['_cw_players_reset'] = 'Der Spielerstatus wurde erfolgreich zur&uuml;ckgesetzt!';
$language_text['_eintrag_titel_forum'] = '<a href="[url]" title="Diesen Beitrag anzeigen"><span class="fontBold">#[postid]</span></a> am [datum] um [zeit]  [edit] [delete]';
$language_text['_eintrag_titel'] = '<span class="fontBold">#[postid]</span> am [datum] um [zeit]  [edit] [delete]';
...
$language_text['_installdir'] = '<tr><td colspan=\"15\" class=\"contentMainFirst\"><br /><div style="text-align:center;"><b>Achtung! Sicherheitsrisiko!!</b><br><br>Bitte l&ouml;sche zuerst den Ordner <b>\'/_installer\'</b> von deinem Webspace. Erst dann steht das Adminmen&uuml; zur Verf&uuml;gung!</div><br /></td></tr>';
...
$language_text['_no_server_navi'] = 'kein Server eingetragen';
$language_text['_vote_menu_no_vote'] = 'keine Umfrage eingetragen';
$language_text['_no_top_match'] = 'kein Top Match eingetragen';
$language_text['_team_logo'] = 'Team Logo';
$language_text['_cw_logo'] = 'Gegner Logo';
$language_text['_cw_screenshot'] = 'Screenshot';
$language_text['_cw_admin_top_setted'] = 'Der Clanwar wurde erfolgreich als Top Match eingetragen!';
$language_text['_cw_admin_top_unsetted'] = 'Der Clanwar wurde erfolgreich als Top Match ausgetragen!';
$language_text['_cw_admin_top_set'] = 'Als Top Match eintragen';
$language_text['_cw_admin_top_unset'] = 'Als Top Match austragen';
$language_text['_sq_banner'] = 'Teambanner';
$language_text['_forum_abo_title'] = 'Thread abbonieren';
...
$language_text['_perm_awards'] = 'Awards verwalten';
$language_text['_perm_clankasse'] = 'Clankasse verwalten';
$language_text['_perm_contact'] = 'Kontakt Formular empfangen';
$language_text['_perm_editkalender'] = 'Kalendereintr&auml;ge  verwalten';
$language_text['_perm_editserver'] = 'Server verwalten';
$language_text['_perm_edittactics'] = 'Taktiken verwalten';
$language_text['_perm_forum'] = 'Foren Admin';
$language_text['_perm_gb'] = 'G&auml;stebuch Admin';
$language_text['_perm_links'] = 'Links verwalten';
$language_text['_perm_newsletter'] = 'Newsletter verschicken';
$language_text['_perm_rankings'] = 'Rankings verwalten';
$language_text['_perm_serverliste'] = 'Serverliste verwalten';
$language_text['_perm_votesadmin'] = 'Umfragen verwalten';
$language_text['_perm_artikel'] = 'Artikel verwalten';
$language_text['_perm_clanwars'] = 'Clanwars verwalten';
...
$language_text['_perm_gallery'] = 'Gallerien verwalten';
$language_text['_perm_glossar'] = 'Glossar verwalten';
$language_text['_perm_intnews'] = 'interne News lesen';
$language_text['_perm_joinus'] = 'JoinUs Formular empfangen';
$language_text['_perm_receivecws'] = 'FightUs Formular empfangen';
...
$language_text['_perm_gs_showpw'] = 'Gameserver Passwort einsehen';
$language_text['_config_positions_rights'] = 'Rechte';
$language_text['_admin_pos'] = 'User R&auml;nge';
$language_text['_awaycal'] = 'Abwesenheitsliste';
$language_text['_clear_away'] = 'Abwesenheitsliste mit einbeziehen?';
...
$language_text['_site_away'] = 'Abwesenheitskalender';
$language_text['_away_list'] = 'Abwesenheitsliste';
$language_text['_config_c_away'] = 'Abwesenheitsliste';
$language_text['_away_status_new'] = '<b><span style="color:#FFA500">Hinzugef&uuml;gt</span></b>';
$language_text['_away_status_now'] = '<b><span style="color:#008000">Aktuell</span></b>';
$language_text['_away_status_done'] = '<b><span style="color:#FF0000">Abgelaufen</span></b>';
$language_text['_away_new'] = 'Melden';
$language_text['_away_empty_titel'] = 'Bitte einen Grund angeben';
$language_text['_away_empty_reason'] = 'Bitte ein Kommentar angeben';
$language_text['_away_error_1'] = 'Das Enddatum darf nicht gleich sein wie das Startdatum!';
$language_text['_away_error_2'] = 'Das Startdatum ist gr&ouml;er als das Enddatum!';
$language_text['_away_to'] = 'bis';
$language_text['_away_to2'] = 'zum';
$language_text['_away_head'] = 'Abwesenheitsliste';
$language_text['_away_new_head'] = 'Abwesenheit eintragen';
$language_text['_away_reason'] = 'Grund';
$language_text['_away_successful_added'] = 'Der Abwesenheitseintrag wurden erfolgreich hinzugef&uuml;gt!';
$language_text['_away_on'] = 'um';
$language_text['_away_info_head'] = 'Abwesenheits Info von';
$language_text['_away_addon'] = 'Eingetragen am';
$language_text['_away_formto'] = 'Von - Bis:';
$language_text['_away_back'] = 'zur&uuml;ck zur Liste';
$language_text['_away_edit_head'] = 'Abwesenheit editieren';
$language_text['_away_successful_del'] = 'Der Abwesenheitseintrag wurde erfolgreich gel&ouml;scht!';
$language_text['_away_successful_edit'] = 'Der Abwesenheitseintrag wurde erfolgreich bearbeitet!';
$language_text['_away_no_entry'] = '<tr><td align="center" class="contentMainFirst" colspan="10"><span class="smallfont">kein Abwesenheitseintrag vorhanden!</span></td></tr>';
$language_text['_lobby_away'] = 'Derzeit abwesend';
$language_text['_lobby_away_new'] = 'Abwesenheitsmeldung';
...
';
$language_text['_user_away_new'] = '[user] - <b>Grund:</b> <a href="../away/?action=info&id=[id]">[what]</a><br />&nbsp;&nbsp;Abwesend vom [ab] bis [wieder]<br />';
$language_text['_user_away_now'] = '[user] - <b>Grund:</b> <a href="../away/?action=info&id=[id]">[what]</a><br />&nbsp;&nbsp;noch bis [wieder] abwesend<br />';
$language_text['_away_today'] = 'einschlie&szlig;lich <b>Heute</b>';
...
$language_text['_send_news_done'] = 'Vielen Dank f&uuml;r das Best&auml;tigen und das einstellen des Newsvoschlags!';
...
$language_text['_clankasse_vwz'] = 'Verwendungszweck';
...
$language_text['_admin_fabo_tedit_subj'] = 'Betreff: ForenAbo Thread editiert';
...
$language_text['_admin_fabo_tedit'] = 'ForenAbo Thread editiert Template';
$language_text['_foum_fabo_checkbox'] = 'Diesen Thread abonnieren und per E-Mail &uuml;ber neue Posts benachrichtigt werden?';
...
####################################################################################
$language_text['_cw_screens_info'] = 'Nur jpg oder gif Dateien!';
...
$language_text['_config_konto'] = 'Clankasse';
$language_text['_config_dl'] = 'Downloadkategorien';
$language_text['_config_nletter'] = 'Newsletter';
$language_text['_config_protocol'] = 'Adminprotokoll';
$language_text['_config_serverlist'] = 'Serverliste';
...
$language_text['_user_new_erase'] = '<form method="get" action="" onsubmit="DZCP.submitButton()"><input type="hidden" name="action" value="erase" /><input id="contentSubmit" type="submit" name="submit" class="submit" value="tempor&auml;re Neuerungen l&ouml;schen" /></form>';
...
$language_text['_confirm_del_shout'] = 'Soll dieser Shoutboxeintrag wirklich gel&ouml;scht werden';
## ADDED FOR 1.4.5
$language_text['_admin_smiley_exists'] = 'Es ist bereits ein Smiley mit diesem Namen vorhanden!';
## ADDED FOR 1.4.3
...
$language_text['_glossar_specialchar'] = 'Es d&uuml;rfen keine Sonderzeichen in der Bezeichnung vorhanden sein!';
$language_text['_admin_gmaps_who'] = 'Memberkarte';
$language_text['_gmaps_who_all'] = 'Alle User anzeigen';
$language_text['_gmaps_who_mem'] = 'Nur Mitglieder anzeigen';
...
$language_text['_membermap_pic'] = 'Userpic';
$language_text['_membermap_nick'] = 'Nick';
$language_text['_membermap_rank'] = 'Position';
$language_text['_membermap_city'] = 'Wohnort';
$language_text['_sponsoren'] = 'Sponsoren';
$language_text['_downloads'] = 'Downloads';
$language_text['_cw'] = 'Clanwars';
$language_text['_awards'] = 'Awards';
$language_text['_serverlist'] = 'Serverliste';
$language_text['_ts'] = 'Teamspeak';
$language_text['_galerie'] = 'Galerie';
$language_text['_kontakt'] = 'Kontakt';
$language_text['_nachrichten'] = 'Nachrichten';
$language_text['_edit_profile'] = 'Profil editieren';
$language_text['_clankasse'] = 'Clankasse';
$language_text['_taktiken'] = 'Taktiken';
...
$language_text['_config_c_teamrow'] = 'Men&uuml;: Teams';
$language_text['_config_c_teamrow_info'] = '(Member pro Zeile)';
...
$language_text['_config_hover_cw'] = 'Nur Clanwar Informationen einblenden';
$language_text['_shout_must_reg'] = 'Nur f&uuml;r registrierte User!';
...
$language_text['_lobby_new_cwc_2'] = 'neue Clanwarkommentare';
$language_text['_admin_glossar_added'] = 'Der Begriff wurde erfolgreich eingetragen!';
$language_text['_admin_glossar_edited'] = 'Der Begriff wurde erfolgreich editiert!';
$language_text['_admin_glossar_deleted'] = 'Der Begriff wurde erfolgreich gel&ouml;scht!';
$language_text['_admin_error_glossar_desc'] = 'Du musst eine Erkl&auml;rung zu dem angegbenen Begriff angeben!';
$language_text['_admin_error_glossar_word'] = 'Du musst einen Begriff angeben!';
$language_text['_admin_glossar_add'] = 'Neuen Begriff eintragen';
$language_text['_config_glossar'] = 'Glossar';
$language_text['_config_gallery'] = 'Galerie';
$language_text['_glossar'] = 'Glossar';
$language_text['_admin_glossar'] = 'Admin: Glossar';
$language_text['_admin_fightus'] = 'FightUs empfangen?';
$language_text['_misc'] = 'Sonstige';
$language_text['_all'] = 'Alle';
$language_text['_glossar_link'] = 'Klicke hier um mehr &uuml;ber <span class=fontBold>[word]</span> zu erfahren!';
$language_text['_glossar_head'] = 'Glossar';
$language_text['_glossar_bez'] = 'Bezeichnung';
$language_text['_glossar_erkl'] = 'Erkl&auml;rung';
...
$language_text['_forum_post_where_preview'] = '<a href="javascript:void(0)">[mainkat]</a> <span class="fontBold">Forum:</span> <a href="javascript:void(0)">[wherekat]</a> <span class="fontBold">Thread:</span> <a href="javascript:void(0)">[wherepost]</a>';
...
$language_text['_pn_write_forum'] = '<a href="../user/?action=msg&amp;do=pn&amp;id=[id]"><img src="../inc/images/forum_pn.gif" alt="" title="[nick] eine Nachricht schreiben" class="icon" /></a>';
$language_text['_uhr'] = '&nbsp;Uhr';
$language_text['_kalender_admin_head'] = 'Kalender - Ereignisse';
$language_text['_smileys_specialchar'] = 'Es d&uuml;rfen keine Sonder- oder Leerzeichen im BBCode angegeben sein!';
$language_text['_award'] = 'Award';
...
$language_text['_only_for_admins'] = ' (f&uuml;r Admins sichtbar)';
$language_text['_content'] = 'Content';
$language_text['_rootadmin'] = 'Seitenadmin';
$language_text['_gb_edit_head'] = 'G&auml;stebucheintrag editieren';
$language_text['_gb_edited'] = 'Der G&auml;stebucheintrag wurde erfolgreich editiert!';
$language_text['_nletter'] = 'Newsletter';
$language_text['_subject'] = 'Betreff';
$language_text['_server_admin_qport'] = 'Optional: Queryport';
$language_text['_admin_server_nostatus'] = 'Keine Live-Abfrage';
$language_text['_nletter_head'] = 'Newsletter verfassen';
$language_text['_squad'] = 'Team';
$language_text['_confirm_del_cw'] = 'Soll dieser Clanwar wirklich geloescht werden';
$language_text['_confirm_del_vote'] = 'Soll diese Umfrage wirklich geloescht werden';
$language_text['_confirm_del_dl'] = 'Soll dieser Download wirklich geloescht werden';
$language_text['_confirm_del_galpic'] = 'Soll dieses Bild wirklich geloescht werden';
$language_text['_confirm_del_gallery'] = 'Soll diese Galerie wirklich geloescht werden';
$language_text['_confirm_del_entry'] = 'Soll dieser Eintrag wirklich geloescht werden';
$language_text['_confirm_del_navi'] = 'Soll dieser Link wirklich geloescht werden';
...
$language_text['_confirm_del_smiley'] = 'Soll dieser Smiley wirklich geloescht werden';
$language_text['_confirm_del_kat'] = 'Soll diese Kategorie wirklich geloescht werden';
$language_text['_confirm_del_news'] = 'Soll diese News wirklich geloescht werden';
$language_text['_confirm_del_site'] = 'Soll diese Seite wirklich geloescht werden';
$language_text['_confirm_del_server'] = 'Soll dieser Server wirklich geloescht werden';
$language_text['_confirm_del_artikel'] = 'Soll dieser Artikel wirklich geloescht werden';
$language_text['_confirm_del_team'] = 'Soll dieses Team wirklich geloescht werden';
$language_text['_confirm_del_award'] = 'Soll dieser Award wirklich geloescht werden';
$language_text['_confirm_del_ranking'] = 'Soll dieses Ranking wirklich geloescht werden';
$language_text['_confirm_del_link'] = 'Soll dieser Link wirklich geloescht werden';
$language_text['_confirm_del_sponsor'] = 'Soll dieser Sponsor wirklich geloescht werden';
$language_text['_confirm_del_kalender'] = 'Soll dieses Ereignis wirklich geloescht werden';
$language_text['_confirm_del_taktik'] = 'Soll diese Taktik wirklich geloescht werden';
...
$language_text['_admin_eml_head'] = 'Emailvorlagen';
...
$language_text['_gallery_show_admin'] = 'Galerie hinzuf&uuml;gen';
...
$language_text['_config_serverliste'] = 'Serverliste';
$language_text['_config_squads'] = 'Teams';
$language_text['_config_backup'] = 'Datenbankbackup';
...
$language_text['_config_clankasse'] = 'Clankasse';
...
$language_text['_config_awards'] = 'Awards';
$language_text['_config_rankings'] = 'Rankings';
...
$language_text['_edited_by'] = '<br /><br /><i>zuletzt editiert von [autor] am [time]</i>';
$language_text['_linkus_empty_text'] = 'Du musst eine Banner-URL angeben!';
$language_text['_gb_titel'] = '<span class="fontBold">#[postid]</span> von [nick] [email] [hp] am [datum] um [zeit][uhr] [edit] [delete] [comment] [public]';
$language_text['_gb_titel_noreg'] = '<span class="fontBold">#[postid]</span> von <span class="fontBold">[nick]</span> [email] [hp] am [datum] um [zeit][uhr]  [edit] [delete] [comment] [public]';
...
$language_text['_smileys_info'] = 'Du kannst alle neuen Smileys auch per FTP in den Ordner <span class="fontItalic">./inc/images/smileys/</span> hochladen! Dabei ist der Dateiname gleich dem des BBCodes. z.B. dzcp.gif = :dzcp:';
...
$language_text['_forum_addpost'] = '<a href="?action=post&amp;do=add&amp;kid=[kid]&amp;id=[id]"><img src="../inc/images/forum_reply.gif" alt="" title="Neuer Eintrag" class="icon" /></a>';
$language_text['_pn_write'] = '<a href="../user/?action=msg&amp;do=pn&amp;id=[id]"><img src="../inc/images/pn.gif" alt="" title="[nick] eine Nachricht schreiben" class="icon" /></a>';
$language_text['_forum_new_thread'] = '<a href="?action=thread&amp;do=add&amp;kid=[id]"><img src="../inc/images/forum_new.gif" alt="" title="Neuen Thread erstellen" class="icon" /></a>';
//--------------------------------------------\\
...
$language_text['_cw_info'] = 'Der Admin f&uuml;r diesen Bereich erh&auml;lt auch die FightUs-Anfragen!';
...
$language_text['_cw_admin_lineup_info'] = 'Namen mit Komma trennen!';
...
## Login ##
$language_text['_login_login'] = 'LogIn!';
## Navigation: Kalender ##
$language_text['_kal_birthday'] = 'Geburtstag von ';
$language_text['_kal_cw'] = 'Clanwar gegen ';
$language_text['_kal_event'] = 'Event: ';
## Linkus ##
//-> Allgemein
$language_text['_linkus_head'] = 'LinkUs';
//-> Admin
$language_text['_linkus_admin_head'] = 'Neues LinkUs definieren';
$language_text['_linkus_link'] = 'Ziellink';
$language_text['_linkus_bsp_target'] = 'http://www.domain.tld';
$language_text['_linkus_bsp_bannerurl'] = 'http://www.domain.tld/banner.jpg';
$language_text['_linkus_bsp_desc'] = 'Beispielclan - Beschreibung';
$language_text['_linkus_beschreibung'] = 'Title';
$language_text['_linkus_text'] = 'Bannerlink';
$language_text['_linkus_empty_beschreibung'] = 'Du musst einen Title-Tag angeben!';
$language_text['_linkus_empty_link'] = 'Du musst eine Link-URL angeben!';
$language_text['_linkus_added'] = 'Das LinkUs wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_linkus_edited'] = 'Das LinkUs wurde erfolgreich editiert!';
$language_text['_linkus_deleted'] = 'Das LinkUs wurde erfolgreich gel&ouml;scht!';
$language_text['_linkus'] = 'LinkUs';
## News ##
$language_text['_news_kommentar'] = 'Kommentar';
$language_text['_news_kommentare'] = 'Kommentare';
$language_text['_news_viewed'] = '[<span class="fontItalic">[viewed] Hits</span>]';
$language_text['_news_archiv'] = '<a href="?action=archiv">Archiv</a>';
$language_text['_news_comment'] = '<a href="?action=show&amp;id=[id]">[comments] Kommentar</a>';
$language_text['_news_comments'] = '<a href="?action=show&amp;id=[id]">[comments] Kommentare</a>';
...
$language_text['_forum_cnt_threads'] = '<span class="fontBold">Anzahl der Threads:</span> [threads]';
...
$language_text['_forum_sticky'] = '<span class="fontWichtig">Wichtig:</span>';
...
$language_text['_forum_thread_lpost'] = 'von [nick]<br />am [date]';
$language_text['_forum_new_thread_head'] = 'Neuen Thread erstellen';
$language_text['_empty_topic'] = 'Du musst ein Topic angeben!';
$language_text['_forum_newthread_successful'] = 'Der Thread wurde erfolgreich ins Forum eingetragen!';
...
$language_text['_forum_post_where'] = '<a href="../forum/">[mainkat]</a> <span class="fontBold">Forum:</span> <a href="?action=show&amp;id=[kid]">[wherekat]</a> <span class="fontBold">Thread:</span> <a href="?action=showthread&amp;id=[tid]">[wherepost]</a>';
...
$language_text['_error_forum_closed'] = 'Dieser Thread ist geschlossen!';
$language_text['_forum_search_head'] = 'Forensuche';
$language_text['_forum_edit_post_head'] = 'Forenpost editieren';
$language_text['_forum_edit_thread_head'] = 'Thread editieren';
$language_text['_forum_editthread_successful'] = 'Der Thread wurde erfolgreich editiert!';
...
$language_text['_forum_admin_open'] = 'Thread ist ge&ouml;ffnet';
$language_text['_forum_admin_delete'] = 'Thread l&ouml;schen?';
$language_text['_forum_admin_close'] = 'Thread ist geschlossen';
$language_text['_forum_admin_moveto'] = 'Thread verschieben nach:';
$language_text['_forum_admin_thread_deleted'] = 'Der Thread wurde erfolgreich gel&ouml;scht!';
$language_text['_forum_admin_do_move'] = 'Der Thread wurde erfolgreich bearbeitet<br />und in die Kategorie <span class="fontWichtig">[kat]</span> verschoben!';
$language_text['_forum_admin_modded'] = 'Der Thread wurde erfolgreich bearbeitet!';
...
$language_text['_forum_nobody_is_online2'] = 'Zur Zeit ist kein User au&szlig;er dir im Forum online!';
## Gaestebuch ##
$language_text['_gb_delete_successful'] = 'Der Eintrag wurde erfolgreich gel&ouml;scht!';
$language_text['_gb_head'] = 'G&auml;stebuch';
$language_text['_gb_add_head'] = 'Neuer G&auml;stebucheintrag';
$language_text['_gb_eintragen'] = '<a href="#eintragen">Eintragen</a>';
$language_text['_gb_entry_successful'] = 'Dein Eintrag ins G&auml;stebuch wurde zur Freischaltung an einem zust&auml;ndigen Admin weitergeleitet!';
$language_text['_gb_addcomment_head'] = 'Kommentar';
$language_text['_gb_addcomment_headgb'] = 'G&auml;stebucheintrag';
$language_text['_gb_comment_added'] = 'Der Kommentar wurde erfolgreich hinzugef&uuml;gt!';
## Kalender ##
//-> Allgemein
...
$language_text['_downloads_added'] = 'Der Download wurde erfolgreich hinzugef&uuml;gt!';
...
$language_text['_member_squad_no_entrys'] = '<tr><td align="center"><span class="fontBold">Keine eingetragenen Member</span></td></tr>';
$language_text['_member_squad_weare'] = 'Wir sind insgesamt <span class="fontBold">[cm] Member</span> und besitzen <span class="fontBold">[cs] Team(s)</span>';
## Clanwars ##
$language_text['_cw_comments_head'] = 'Clanwarkommentare';
$language_text['_cw_comments_add'] = 'Neuen Kommentar schreiben';

$language_text['_cw_head_details'] = 'Clanwar Details';
$language_text['_cw_head_results'] = 'Ergebnisse';
$language_text['_cw_head_lineup'] = 'Lineup';
$language_text['_cw_head_glineup'] = 'Gegner Lineup';
$language_text['_cw_head_admin'] = 'Admin(s)';
$language_text['_cw_head_squad'] = 'Team';
$language_text['_cw_bericht'] = 'Bericht';
...
$language_text['_cw_players_head'] = 'Spielerstatus';
$language_text['_cw_status_set'] = 'Dein Status wurde erfolgreich gesetzt!';
$language_text['_cw_players_play'] = 'Kannst/willst/m&ouml;chtest du spielen?';
$language_text['_cw_player_dont_want'] = '<span class="fontRed">m&ouml;chte nicht spielen</span>';
$language_text['_cw_player_want'] = '<span class="fontGreen">m&ouml;chte spielen</span>';
$language_text['_cw_player_dont_know'] = 'wei&szlig; es noch nicht';
$language_text['_cw_admin_head'] = 'Neuen Clanwar hinzuf&uuml;gen';
$language_text['_cw_admin_head_edit'] = 'Clanwar editieren';
$language_text['_cw_admin_info'] = 'Solange kein Ergebnis eingetragen ist, wird der War als "Next War" angezeigt!';
$language_text['_cw_admin_gegnerstuff'] = 'Angaben zum Gegner';
$language_text['_cw_admin_clantag'] = 'Clank&uuml;rzel';
$language_text['_cw_admin_warstuff'] = 'Angaben zum Clanwar';
$language_text['_cw_admin_maps'] = 'Maps';
$language_text['_cw_admin_serverip'] = 'ServerIP';
$language_text['_cw_admin_empty_gegner'] = 'Du musst den Namen des Gegners angeben!';
$language_text['_cw_admin_empty_clantag'] = 'Du musst das Clank&uuml;rzel des Gegners angeben!';
$language_text['_cw_admin_deleted'] = 'Der Clanwar wurde erfolgreich gel&ouml;scht!';
$language_text['_cw_admin_added'] = 'Der Clanwar wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_cw_admin_edited'] = 'Der Clanwar wurde erfolgreich editiert!';
$language_text['_cw_admin_head_squads'] = 'Angaben zum Team';
$language_text['_cw_admin_head_country'] = 'Land';
$language_text['_cw_head_statstik'] = 'Statistik';
$language_text['_cw_gespunkte'] = 'Gesamtpunktzahl';
$language_text['_cw_stats_ges_wars'] = '<span class="fontText">Unser Clan hat insgesamt <span class="fontBold">[ge_wars]</span> Clanwar(s) gespielt.</span>';
$language_text['_cw_stats_ges_wars_sq'] = '<span class="fontText">Dieses Team hat insgesamt <span class="fontBold">[ge_wars]</span> Clanwar(s) gespielt.</span>';
$language_text['_cw_stats_ges_points'] = 'Die Gesamtpunktzahl betr&auml;gt: <span class="CwWon">[ges_won]</span> : <span class="CwLost">[ges_lost]</span>';
$language_text['_cw_stats_spiele_squads'] = 'Wir spielen insgesamt mit <span class="fontBold">[anz_squads]</span> Team(s) verteilt auf <span class="fontBold">[anz_games]</span> Spiel(en).';
$language_text['_cw_stats_won_head'] = 'Won';
$language_text['_cw_stats_lost_head'] = 'Lost';
$language_text['_cw_stats_draw_head'] = 'Draw';
$language_text['_cw_head_clanwars'] = 'Clanwars';
$language_text['_cw_head_game'] = 'Spiel';
$language_text['_cw_head_datum'] = 'Datum';
$language_text['_cw_head_gegner'] = 'Gegner';
$language_text['_cw_head_liga'] = 'Liga';
$language_text['_cw_head_gametype'] = 'Spielart';
$language_text['_cw_head_xonx'] = 'XonX';
$language_text['_cw_head_result'] = 'Punkte';
$language_text['_cw_head_details_show'] = 'Details';
$language_text['_cw_head_page'] = 'Seite: ';
$language_text['_cw_head_legende'] = 'Legende';
$language_text['_cw_nothing'] = '<option value="lazy" class="" class="dropdownKat">--- nichts &auml;ndern ---</option>';
$language_text['_cw_screens'] = 'Screenshots';
$language_text['_cw_new'] = 'Neuer';
$language_text['_clanwars_no_show'] = 'Noch keine Clanwars vorhanden!';
...
## Awards ##
$language_text['_awards_head'] = 'Awards';
$language_text['_awards_head_squad'] = 'Team';
$language_text['_awards_head_date'] = 'Datum';
$language_text['_awards_head_place'] = 'Platz';
$language_text['_awards_head_prize'] = 'Preis';
$language_text['_awards_head_event'] = 'Event-Name';
$language_text['_awards_head_link'] = 'Event-Link';
...
$language_text['_awards_empty_url'] = 'Du musst einen Event Link angeben!';
$language_text['_awards_empty_event'] = 'Du musst ein Event Namen angeben!';
$language_text['_awards_admin_head_add'] = 'Neuen Award hinzuf&uuml;gen';
$language_text['_awards_admin_added'] = 'Der Award wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_awards_admin_head_edit'] = 'Award editieren';
$language_text['_awards_admin_edited'] = 'Der Award wurde erfolgreich editiert!';
$language_text['_awards_admin_deleted'] = 'Der Award wurde erfolgreich gel&ouml;scht!';
$language_text['_awards_head_legende'] = 'Legende';
## Rankings ##
$language_text['_error_empty_league'] = 'Du musst eine Liga angeben!';
$language_text['_error_empty_url'] = 'Du musst einen Teamlink angeben!';
$language_text['_error_empty_rank'] = 'Du musst einen Platz angeben!';
## Server ##
$language_text['_banned_reason'] = 'Grund';
$language_text['_banned_head'] = 'Bannliste';
$language_text['_banned_gesamt'] = '<span class="fontText">Insgesamt sind</span> <span class="fontBold">[ges] User</span> <span class="fontText">in der Bannliste</span>';
$language_text['_banned_edit_head'] = 'Bannliste editieren';
$language_text['_error_banned_edited'] = 'Der gebannte User wurde erfolgreich editiert!';
$language_text['_server_head'] = 'Server';
$language_text['_server_name'] = 'Servername';
$language_text['_server_pwd'] = '<span class="fontBold">Passwort:</span> [pwd]';
$language_text['_server_ip'] = 'IP';
$language_text['_server_players'] = 'Spieler';
$language_text['_server_aktmap'] = 'akt. Map';
$language_text['_server_frags'] = 'Frags';
$language_text['_server_time'] = 'gespielte Zeit';
...
$language_text['_server_splayerstats'] = 'Spielerstatistiken';
$language_text['_generated_time'] = 'Die Seite wurde in [time] Sekunden generiert';
$language_text['_slist_head'] = 'Serverliste';
$language_text['_slist_serverip'] = 'ServerIP';
$language_text['_slist_slots'] = 'Slots';
$language_text['_slist_add'] = 'Server hinzuf&uuml;gen';
$language_text['_slist_serverport'] = 'Server-Port';
$language_text['_slist_addip'] = 'Klicke auf die ServerIP um diese im HLSW aufzurufen';
$language_text['_slist_added_msg'] = 'Es ist ein neuer Eintrag in der Serverliste vorhanden!';
$language_text['_slist_title'] = 'Serverliste';
$language_text['_server_password'] = 'Serverpasswort';
$language_text['_error_server_saved'] = 'Dein Server wurde erfolgreich eingetragen!<br /> Ein Admin wird nun deine Angaben &uuml;berpr&uuml;fen.';
$language_text['_error_empty_slots'] = 'Du musst die Anzahl euer Slots angeben!';
$language_text['_error_empty_ip'] = 'Du musst eure Server-IP angeben!';
$language_text['_error_empty_port'] = 'Du musst euren Server-Port angeben!';
$language_text['_gallery_head'] = 'Galerien';
$language_text['_subgallery_head'] = 'Galerie';
$language_text['_gallery_images'] = 'Bilder';
$language_text['_gal_back'] = 'zur&uuml;ck';
$language_text['_gallery_admin_head'] = 'Galerie hinzuf&uuml;gen';
$language_text['_gallery_gallery'] = 'Galeriebezeichnung';
$language_text['_gallery_count'] = 'Anzahl der Bilder';
$language_text['_gallery_count_new'] = 'Anzahl neuer Bilder';
$language_text['_gallery_added'] = 'Die Galerie wurde erfolgreich erstellt!';
$language_text['_error_gallery'] = 'Du musst eine Galeriebezeichnung angeben!';
$language_text['_gallery_image'] = 'Bild';
$language_text['_gallery_deleted'] = 'Die Galerie wurde erfolgreich gel&ouml;scht!';
$language_text['_gallery_edited'] = 'Die Galerie wurde erfolgreich editiert!';
$language_text['_gallery_admin_edit'] = 'Galerie editieren';
$language_text['_gallery_pic_deleted'] = 'Das Bild wurde erfolgreich gel&ouml;scht!';
$language_text['_gallery_new'] = 'Die Bilder wurden erfolgreich zur Galerie hinzugef&uuml;gt!';
$language_text['_button_value_newgal'] = 'Weitere Bilder hinzuf&uuml;gen';
$language_text['_contact_pflichtfeld'] = '<span class="fontWichtig">*</span> = Pflichtfelder';
$language_text['_contact_nachricht'] = 'Nachricht';
$language_text['_contact_sended'] = 'Deine Nachricht wurde erfolgreich an den Seitenadmin weitergeleitet!';
$language_text['_contact_title'] = 'Kontaktformular';
...
$language_text['_contact_joinus'] = 'JoinUs-Text';
$language_text['_contact_joinus_why'] = 'Beschreibe kurz, warum du bei uns aufgenommen werden willst.';
$language_text['_contact_title_joinus'] = 'JoinUs-Kontaktformular';
...
<span class="fontBold">Team:</span> [squad]<br /><br />
<span class="fontUnder"><span class="fontBold">Nachricht:</span></span><br />[text]';
$language_text['_contact_joinus_no_squad_aviable'] = 'Kein Team verf&uuml;gbar';
$language_text['_contact_joinus_sended'] = 'Dein Joinus-Anfrage wurde erfolgreich an den zust&auml;ndigen Seitenadmin weitergeleitet!';
$language_text['_contact_fightus'] = 'Kommentar';
$language_text['_contact_title_fightus'] = 'FightUs-Kontaktformular';
$language_text['_contact_fightus_sended'] = 'Dein Clanwar-Anfrage wurde erfolgreich einen zust&auml;ndigen Admin weitergeleitet!';
$language_text['_contact_fightus_partner'] = 'Ansprechpartner';
$language_text['_contact_fightus_clandata'] = 'Clandaten';
$language_text['_contact_fightus_clanname'] = 'Clanname';
$language_text['_fightus_maps'] = 'Eure Map';
$language_text['_empty_fightus_map'] = 'Du musst die Map angeben, die ihr spielen wollt!';
$language_text['_empty_fightus_game'] = 'Du musst das Spiel angeben, in dem der War stattfinden soll!';
## Statistiken ##
$language_text['_site_stats'] = 'Statistiken';
$language_text['_stats'] = 'Statistiken';
$language_text['_stats_nkats'] = 'Kategorien';
$language_text['_stats_news'] = 'geschriebene News';
$language_text['_stats_comments'] = 'geschriebene Kommentare';
$language_text['_stats_cpern'] = '&oslash; Kommentare pro News';
$language_text['_stats_npert'] = '&oslash; News pro Tag';
$language_text['_stats_gb_all'] = 'Gesamteintr&auml;ge';
$language_text['_stats_gb_poster'] = 'Eintr&auml;ge G&auml;ste/reg. User';
$language_text['_stats_gb_first'] = 'Erster Eintrag';
$language_text['_stats_gb_last'] = 'Letzter Eintrag';
$language_text['_from'] = 'von';
$language_text['_stats_forum_ppert'] = '&oslash; Beitr&auml;ge pro Thread';
$language_text['_stats_forum_pperd'] = '&oslash; Beitr&auml;ge pro Tag';
$language_text['_stats_forum_top'] = 'Top Poster';
$language_text['_stats_users_regged'] = 'reg. User';
$language_text['_stats_users_regged_member'] = '&nbsp;&nbsp;- davon Member';
$language_text['_stats_users_logins'] = 'Gesamt Logins';
$language_text['_stats_users_msg'] = 'versendete Nachrichten';
$language_text['_stats_users_buddys'] = 'Buddies';
$language_text['_stats_users_votes'] = 'teilgenommene Votes';
$language_text['_stats_users_aktmsg'] = '&nbsp;&nbsp;- davon aktuell im Umlauf';
$language_text['_stats_cw_played'] = 'gespielte Clanwars';
$language_text['_stats_cw_won'] = '&nbsp;&nbsp;- davon gewonnen';
$language_text['_stats_cw_draw'] = '&nbsp;&nbsp;- davon unentschieden';
$language_text['_stats_cw_lost'] = '&nbsp;&nbsp;- davon verloren';
$language_text['_stats_cw_points'] = 'Gesamtpunktzahl';
$language_text['_stats_place'] = '&nbsp;&nbsp;- davon Platz';
$language_text['_stats_place_misc'] = '&nbsp;&nbsp;- davon sonstige Pl&auml;tze';
$language_text['_stats_awards'] = 'Gewonnene Awards';
$language_text['_stats_mysql'] = 'MySQL-Datenbank';
$language_text['_stats_mysql_size'] = 'Datenbankgr&ouml;&szlig;e';
$language_text['_stats_mysql_entrys'] = 'Tabellen';
$language_text['_stats_mysql_rows'] = 'Gesamteintr&auml;ge';
$language_text['_site_stats_files'] = 'Dateien';
$language_text['_stats_hosted'] = 'selbst gehostete Dateien';
$language_text['_stats_dl_size'] = 'Gesamtgr&ouml;&szlig;e';
$language_text['_stats_dl_traffic'] = 'Insgesamt verursachter Traffic';
$language_text['_stats_dl_hits'] = 'Insgesamt herruntergeladen';
## User ##
...
$language_text['_profil_navi_profil'] = '<a href="?action=user&amp;id=[id]">Profil</a>';
$language_text['_profil_navi_gb'] = '<a href="?action=user&amp;id=[id]&amp;show=gb">G&auml;stebuch</a>';
$language_text['_profil_navi_gallery'] = '<a href="?action=user&amp;id=[id]&amp;show=gallery">Galerie</a>';
...
$language_text['_pedit_visibility_gb'] = 'G&auml;stebuch Posts';
$language_text['_pedit_visibility_gallery'] = 'Gallerie';
$language_text['_pedit_perm_public'] = '<option value="0" selected="selected">Public</option><option value="1">User only</option><option value="2">Member only</option>';
$language_text['_pedit_perm_user'] = '<option value="0">Public</option><option value="1" selected="selected">User only</option><option value="2">Member only</option>';
$language_text['_pedit_perm_member'] = '<option value="0">Public</option><option value="1">User only</option><option value="2" selected="selected">Member only</option>';
...
$language_text['_gallery_no_perm'] = '<div align="center"><br/>Du hast keine berechtigung diese Gallerie zu sehen</div>';
$language_text['_profil_cws'] = 'teilgenommene CW`s';
...
$language_text['_pedit_aktiv'] = '<option value="1" selected="selected">aktiv</option><option value="0">inaktiv</option>';
$language_text['_pedit_inaktiv'] = '<option value="1">aktiv</option><option value="0" selected="selected">inaktiv</option>';
...
$language_text['_profil_edit_gallery_link'] = '<a href="?action=editprofile&amp;show=gallery">Usergalerie editieren</a>';
...
$language_text['_msg_select_all'] = 'alle ausw&auml;hlen';
...
$language_text['_usergb_eintragen'] = '<a href="?action=usergb&amp;id=[id]">Eintragen</a>';
$language_text['_usergb_entry_successful'] = 'Dein Eintrag ins Profilg&auml;stebuch war erfolgreich!';
$language_text['_gallery_pic'] = 'Bild';
$language_text['_gallery_beschr'] = 'Beschreibung';
$language_text['_gallery_edit_new'] = '<a href="../upload/?action=usergallery">Neues Bild hinzuf&uuml;gen</a>';
$language_text['_info_edit_gallery_done'] = 'Du hast den Datensatz erfolgreich gel&ouml;scht!';
...
$language_text['_admin_user_clankasse'] = 'Admin: Clankasse';
$language_text['_admin_user_serverliste'] = 'Admin: Serverliste';
$language_text['_admin_user_editserver'] = 'Admin: Server';
$language_text['_admin_user_edittactics'] = 'Admin: Taktiken';
...
$language_text['_member_admin_gb'] = 'Admin: G&auml;stebuch';
...
$language_text['_last_forum'] = 'Letzten 10 Forumthreads';
$language_text['_lobby_forum'] = 'Forenbeitr&auml;ge';
$language_text['_new_post_1'] = 'neuer Post';
$language_text['_new_post_2'] = 'neue Posts';
$language_text['_new_thread'] = 'im Thread ';
$language_text['_no_new_thread'] = 'Neuer Thread:';
$language_text['_lobby_gb'] = 'G&auml;stebucheintr&auml;ge';
$language_text['_new_gb'] = '<br /><span class="fontBoldUnder">G&auml;stebuch:</span><br />';
...
$language_text['_lobby_membergb'] = 'Mein Profilg&auml;stebuch';
...
$language_text['_user_new_cw'] = '<tr><td style="width:22px;text-align:center"><img src="../inc/images/gameicons/[icon]" class="icon" alt="" /></td><td style="vertical-align:middle"><a href="../clanwars/?action=details&amp;id=[id]">Clanwar am <span class="fontWichtig">[datum]</span> gegen <span class="fontWichtig">[gegner]</span></a></td></tr>';
...
$language_text['_admin_user_awards'] = 'Admin: Awards';
$language_text['_userlobby_kal_today'] = 'N&auml;chster Event ist <a href="../kalender/?action=show&time=[time]"><span class="fontWichtig">heute - [event]</span></a>';
$language_text['_userlobby_kal_not_today'] = 'N&auml;chstes Event ist am <a href="../kalender/?action=show&time=[time]"><span class="fontUnder">[date] - [event]</span></a>';
$language_text['_profil_country'] = 'Land';
$language_text['_lobby_awards'] = 'Awards';
$language_text['_new_awards_1'] = 'neuer Award';
$language_text['_new_awards_2'] = 'neue Awards';
$language_text['_lobby_rankings'] = 'Rankings';
$language_text['_new_rankings_1'] = 'neue Ver&auml;nderung';
$language_text['_new_rankings_2'] = 'neue Ver&auml;nderungen';
$language_text['_profil_favos'] = 'Favoriten';
$language_text['_profil_drink'] = 'Drink';
$language_text['_profil_essen'] = 'Essen';
$language_text['_profil_film'] = 'Film';
$language_text['_profil_musik'] = 'Musik';
$language_text['_profil_song'] = 'Song';
$language_text['_profil_buch'] = 'Buch';
$language_text['_profil_autor'] = 'Autor';
$language_text['_profil_person'] = 'Person';
$language_text['_profil_sport'] = 'Sport';
$language_text['_profil_sportler'] = 'Sportler';
$language_text['_profil_auto'] = 'Auto';
$language_text['_profil_favospiel'] = 'Spiel';
$language_text['_profil_game'] = 'Spiel';
$language_text['_profil_favoclan'] = 'Clan';
$language_text['_profil_spieler'] = 'Spieler';
$language_text['_profil_map'] = 'Map';
$language_text['_profil_waffe'] = 'Waffe';
$language_text['_profil_rasse'] = 'Rasse';
...
$language_text['_lobby_gallery'] = 'Galerien';
$language_text['_new_gal_1'] = 'neue Galerie';
$language_text['_new_gal_2'] = 'neue Galerien';
## Upload ##
...
$language_text['_upload_head_usergallery'] = 'Usergalerie bearbeiten';
$language_text['_edit_gallery_done'] = 'Die Usergalerie wurde erfolgreich bearbeitet!';
...
$language_text['_upload_taktiken_head'] = 'Taktikscreens';
...
$language_text['_error_no_teamspeak'] = 'Der Teamspeakserver ist zur Zeit nicht erreichbar!';
...
$language_text['_nav_no_nextwars'] = 'Es stehen keine Wars an!';
$language_text['_nav_no_lastwars'] = 'Bisher noch keine Wars!';
$language_text['_nav_no_ftopics'] = 'Noch kein Eintrag!';
$language_text['_gallery_folder_exists'] = 'Der angegebene Ordner existiert bereits!';
$language_text['_server_isnt_live'] = 'Der Server ist auf keinen Live-Status eingestellt!';
$language_text['_target'] = 'Neues Fenster';
$language_text['_rankings_edit_head'] = 'Ranking editieren';
...
$language_text['_forum_global'] = '<span class="fontWichtig">Global:</span>';
...
$language_text['_info_res'] = 'Aufl&ouml;sung';
$language_text['_unknown_browser'] = 'unbekannter Browser';
$language_text['_unknown_system'] = 'unbekanntes System';
$language_text['_info_sys'] = 'System';
...
## Taktiken ##
$language_text['_taktik_head'] = 'Intern: Taktiken';
$language_text['_taktik_standard_t'] = '<a href="?action=standard&amp;what=t&amp;id=[id]">Verteidigung</a>';
$language_text['_taktik_standard_ct'] = '<a href="?action=standard&amp;what=ct&amp;id=[id]">Verteidigung</a>';
$language_text['_taktik_spar_t'] = '<a href="?action=spar&amp;what=t&amp;id=[id]">Angriff</a>';
$language_text['_taktik_spar_ct'] = '<a href="?action=spar&amp;what=ct&amp;id=[id]">Angriff</a>';
$language_text['_taktik_upload'] = 'Tatkikscreen uploaden';
$language_text['_taktik_t'] = 'Team 2';
$language_text['_taktik_ct'] = 'Team 1';
$language_text['_taktik_posted'] = 'posted by <span class="fontBold">[autor]</span> - [datum]';
$language_text['_taktik_headline'] = '<span class="fontBold">Map:</span> [map] - <span class="fontBold">Taktik:</span> [what]';
$language_text['_taktik_tstandard_t'] = 'Team 2 -> Verteidigung';
$language_text['_taktik_tstandard_ct'] = 'Team 1 -> Verteidigung';
$language_text['_taktik_tspar_t'] = 'Team 2 -> Angriff';
$language_text['_taktik_tspar_ct'] = 'Team 1 -> Angriff';
$language_text['_error_taktik_empty_map'] = 'Du musst eine Map angeben!';
$language_text['_taktik_new'] = 'Neue Taktik hinzuf&uuml;gen';
$language_text['_taktik_added'] = 'Die Taktik wurde erfolgreich eingetragen!';
$language_text['_taktik_deleted'] = 'Die Taktik wurde erfolgreich gel&ouml;scht!';
$language_text['_taktik_edit_head'] = 'Taktik editieren';
$language_text['_taktik_new_head'] = 'Neue Taktik';
$language_text['_error_taktik_edited'] = 'Die Taktik wurde erfolgreich editiert!';
## Impressum ##
...
$language_text['_config_clankasse_head'] = 'Ein-/Auszahlungsbezeichnungen';
$language_text['_backup_head'] = 'Datenbankbackup';
$language_text['_backup_info_head'] = 'Anmerkung';
$language_text['_backup_info'] = 'Der Backupvorgang kann je nach Gr&ouml;&szlig;e der Datenbank mehrere Minuten in Anspruch nehmen.';
$language_text['_backup_link'] = 'neues Backup anlegen!';
$language_text['_backup_successful'] = 'Das Datenbankbackup wurde erfolgreich angelegt!';
$language_text['_backup_last_head'] = 'Letztes Backup';
$language_text['_backup_last_not_exist'] = 'Du hast bisher noch kein MySQL-Datenbankbackup angelegt!';
...
$language_text['_member_admin_header'] = 'Teambereich';
$language_text['_member_admin_squad'] = 'Team';
$language_text['_member_admin_game'] = 'Game';
$language_text['_member_admin_icon'] = 'Icon';
$language_text['_member_admin_add'] = '<a href="?admin=squads&amp;do=add">Team hinzuf&uuml;gen</a>';
$language_text['_admin_squad_deleted'] = 'Das Team wurde erfolgreich gel&ouml;scht!';
$language_text['_member_admin_add_header'] = 'Team hinzuf&uuml;gen';
$language_text['_admin_squad_no_squad'] = 'Du musst einen Teamnamen angeben!';
$language_text['_admin_squad_no_game'] = 'Du musst ein Game angeben, welches dieses Team spielt!';
$language_text['_admin_squad_add_successful'] = 'Das Team wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_admin_squad_edit_successful'] = 'Das Team wurde erfolgreich editiert!';
$language_text['_member_admin_edit_header'] = 'Team editieren';
$language_text['_error_server_edit'] = 'Der Server wurde erfolgreich editiert!';
$language_text['_error_empty_clanname'] = 'Du musst euren Clannamen angeben!';
$language_text['_error_server_accept'] = 'Die ausgew&auml;hlten Server wurden erfolgreich freigeschaltet!';
$language_text['_error_server_dont_accept'] = 'Die ausgew&auml;hlten Server wurden erfolgreich aus der Liste genommen!';
$language_text['_slist_head_admin'] = 'Serverliste';
$language_text['_slist_server_deleted'] = 'Der Server wurde erfolgreich gel&ouml;scht!';
$language_text['_server_admin_head'] = 'Server';
$language_text['_server_add_new'] = '<a href="?admin=server&amp;do=new">Neuen Server hinzuf&uuml;gen</a>';
$language_text['_admin_server_edit'] = 'Server editieren';
$language_text['_empty_ip'] = 'Du musst eine IP angeben!';
$language_text['_server_admin_edited'] = 'Der Server wurde erfolgreich editiert!';
$language_text['_server_admin_deleted'] = 'Der Server wurde erfolgreich gel&ouml;scht!';
$language_text['_admin_server_new'] = 'Neuen Server hinzuf&uuml;gen';
$language_text['_server_admin_added'] = 'Der Server wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_empty_game'] = 'Du musst ein Icon ausw&auml;hlen!';
$language_text['_empty_servername'] = 'Du musst einen Servernamen angeben!';
$language_text['_config_server_mapname'] = 'Mapname';
$language_text['_config_server_maps_head'] = 'Servermaps';
$language_text['_config_server_map_deleted'] = 'Der Mapscreen wurde erfolgreich gel&ouml;scht!';
$language_text['_admin_dlkat'] = 'Downloadkategorien';
$language_text['_admin_download_kat'] = 'Bezeichnung';
...
$language_text['_config_c_usergb'] = 'User-G&auml;stebuch';
$language_text['_config_c_clankasse'] = 'Clankasse';
$language_text['_config_c_gb'] = 'G&auml;stebuch';
...
$language_text['_config_c_fthreads'] = 'Forumthreads';
...
$language_text['_config_c_shouttext'] = 'Shoutbox: Text';
...
$language_text['_config_c_lcws'] = 'Clanwars: Gegnername';
$language_text['_config_c_lwars'] = 'Men&uuml;: Last Wars';
$language_text['_config_c_nwars'] = 'Men&uuml;: Next Wars';
...
$language_text['_config_c_gallerypics'] = 'User: Usergalerie';
...
$language_text['_config_c_antispam_type'] = 'Antispam: Typ';
$language_text['_config_c_antispam_type_what'] = 'W&auml;hlt den Typ des Antispam-Generators (Bildcode oder Rechenaufgabe)';
$language_text['_antispam_image'] = 'Bildcode (Standard)';
$language_text['_antispam_math'] = 'Rechenaufgabe';
...
$language_text['_admin_clankasse_add'] = '<a href="?admin=konto&amp;do=new">Neue Bezeichnung hinzuf&uuml;gen</a>';
$language_text['_clankasse_new_head'] = 'Neue Ein-/Auszahlungsbezeichnung hinzuf&uuml;gen';
$language_text['_clankasse_edit_head'] = 'Ein-/Auszahlungsbezeichnung editieren';
$language_text['_clankasse_empty_kat'] = 'Du musst eine Ein-/Auszahlungsbezeichnung angeben!';
$language_text['_clankasse_kat_added'] = 'Die Ein-/Auszahlungsbezeichnung wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_clankasse_kat_edited'] = 'Die Ein-/Auszahlungsbezeichnung wurde erfolgreich editiert!';
$language_text['_clankasse_kat_deleted'] = 'Die Ein-/Auszahlungsbezeichnung wurde erfolgreich gel&ouml;scht!';
$language_text['_config_c_gallery'] = 'Galerie';
$language_text['_config_info_gallery'] = 'Anzahl der Bilder die maximal in einer Reihe gezeigt werden';
$language_text['_config_server_ts_updated'] = 'Die Teamspeak IP wurde erfolgreich gesetzt!';
$language_text['_ts_sport'] = 'Server Queryport';
$language_text['_ts_width'] = 'Breite der Anzeige';
$language_text['_config_c_awards'] = 'Awards';
$language_text['_counter_start'] = 'Counter';
$language_text['_counter_start_info'] = 'Hier kannst du eine Zahl eintragen, die zum Counter dazu addiert wird.';
$language_text['_admin_nc'] = 'Newskommentare';
$language_text['_admin_reg_head'] = 'Registrierungspflicht';
$language_text['_config_shoutarchiv'] = 'Shoutbox: Archiv';
$language_text['_config_zeichen'] = 'Shoutbox: Zeichen';
$language_text['_config_zeichen_info'] = 'Hier kannst du einstellen, nach wieviel Zeichen das Eingabefeld der Shoutbox gesperrt wird.';
...
$language_text['_editor_allow_html'] = 'HTML erlauben?';
...
$language_text['_navi_standard'] = 'Der Standard wurde erfolgreich wiederhergestellt!';
...
$language_text['_clear_deleted'] = 'Die Datenbank wurde erfolgreich aufger&auml;umt!';
$language_text['_clear_error_days'] = 'Du musst die Tage angeben, ab wann etwas gel&ouml;scht werden soll!';
$language_text['_admin_status'] = 'Live-Status';
...
$language_text['_admin_user_gallery'] = 'Admin: Galerie';
$language_text['_user_admin_joinus'] = 'JoinUs empfangen?';
$language_text['_user_admin_contact'] = 'Kontakt empfangen?';
$language_text['_user_admin_formulare'] = 'Formulare';
$language_text['_smileys_error_file'] = 'Du musst ein Smiley angeben!';
$language_text['_smileys_error_bbcode'] = 'Du musst ein BB-Code angeben!';
$language_text['_smileys_error_type'] = 'Es sind nur GIF-Dateien erlaubt!';
$language_text['_smileys_added'] = 'Das Smiley wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_smileys_edited'] = 'Das Smiley wurde erfolgreich editiert!';
$language_text['_smileys_deleted'] = 'Das Smiley wurde erfolgreich gel&ouml;scht!';
$language_text['_smileys_normals'] = 'Standardsmileys (k&ouml;nnen nicht gel&ouml;scht werden!)';
$language_text['_smileys_customs'] = 'Neue Smileys';
$language_text['_smileys_head'] = 'Smiley-Editor';
$language_text['_smileys_smiley'] = 'Smiley';
$language_text['_smileys_bbcode'] = 'BBCode';
$language_text['_smileys_head_add'] = 'Neuen Smiley hinzuf&uuml;gen';
$language_text['_smileys_head_edit'] = 'Smiley editieren';
$language_text['_head_waehrung'] = 'W&auml;hrung';
$language_text['_dl_version'] = 'downloadbare Version';
...
$language_text['_c_l_shoutnick'] = 'Men&uuml;: Shoutbox: Nick';
...
$language_text['_cw_comments'] = 'Clanwarkommentare';
...
$language_text['_profile_del_confirm'] = 'Achtung, es gehen alle Usereingaben f&uuml;r dieses Feld verloren. Willst du es wirklich l&ouml;schen?';
$language_text['_profile_about'] = '&uuml;ber mich';
$language_text['_profile_clan'] = 'Clan';
$language_text['_profile_contact'] = 'Kontakt';
$language_text['_profile_favos'] = 'Favoriten';
$language_text['_profile_hardware'] = 'Hardware';
$language_text['_profile_name'] = 'Feldname';
$language_text['_profile_type'] = 'Feldtyp';
$language_text['_profile_kat'] = 'Kategorie';
$language_text['_profile_head'] = 'Profilfelderverwaltung';
$language_text['_profile_edit_head'] = 'Profilfeld editieren';
$language_text['_profile_shown'] = 'Sichtbar';
$language_text['_profile_type_1'] = 'Textfeld';
$language_text['_profile_type_2'] = 'URL';
$language_text['_profile_type_3'] = 'Email-Adresse';
...
$language_text['_profile_add_head'] = 'Profilfeld hinzuf&uuml;gen';
$language_text['_profile_added'] = 'Das Profilfeld wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_profil_no_name'] = 'Du musst einen Feldnamen angeben!';
$language_text['_profil_deleted'] = 'Das Profilfeld wurde erfolgreich gel&ouml;scht!';
$language_text['_profile_edited'] = 'Das Profilfeld wurde erfolgreich editiert!';
## Clankasse ##
$language_text['_clankasse_saved'] = 'Der Beitrag wurde erfolgreich zur Clankasse hinzugef&uuml;gt!';
$language_text['_clankasse_deleted'] = 'Der Beitrag wurde erfolgreich aus der Clankasse gel&ouml;scht!';
$language_text['_error_clankasse_empty_datum'] = 'Du musst ein Datum angeben!';
$language_text['_clankasse_edited'] = 'Der Betrag wurde erfolgreich editiert!';
$language_text['_error_clankasse_empty_transaktion'] = 'Du musst eine Beschreibung der Transaktion angeben!';
$language_text['_error_clankasse_empty_betrag'] = 'Du musst einen Betrag angeben!';
$language_text['_clankasse_ctransaktion'] = 'Was';
$language_text['_clankasse_cbetrag'] = 'Betrag';
$language_text['_clankasse_server_head'] = 'Clankonto';
$language_text['_clankasse_nr'] = 'Kontonr.';
$language_text['_clankasse_blz'] = 'Bankleitzahl';
$language_text['_clankasse_inhaber'] = 'Inhaber';
$language_text['_clankasse_bank'] = 'Bank';
$language_text['_clankasse_head'] = 'Clankasse';
$language_text['_clankasse_cakt'] = 'aktueller Kontostand';
$language_text['_clankasse_admin_minus'] = 'Minus';
...
$language_text['_clankasse_trans'] = '[transaktion] von/an [member]';
$language_text['_clankasse_head_edit'] = 'Beitrag editieren';
$language_text['_clankasse_head_new'] = 'Neuen Beitrag hinzuf&uuml;gen';
$language_text['_clankasse_sonstiges'] = 'sonstiges';
$language_text['_clankasse_for'] = 'von/an';
$language_text['_clankasse_einzahlung'] = '-> Einzahlung';
$language_text['_clankasse_auszahlung'] = '-> Auszahlung';
$language_text['_clankasse_didpayed'] = 'Zahlstatus';
$language_text['_clankasse_status_status'] = 'Status';
$language_text['_clankasse_status_bis'] = 'bis';
$language_text['_clankasse_status_payed'] = '<span class="fontGreen">bezahlt</span> bis zum <span>[payed]</span>';
$language_text['_clankasse_status_today'] = '<span class="fontGreen">bezahlt</span> bis <span class="fontBold">heute</span>';
$language_text['_clankasse_status_notpayed'] = '<span class="fontRed">&uuml;berf&auml;llig</span> seit dem <span class="fontBold">[payed]</span>';
$language_text['_clankasse_status_noentry'] = 'noch kein Eintrag';
$language_text['_clankasse_edit_paycheck'] = 'Zahlstatus editieren';
$language_text['_clankasse_payed_till'] = 'bezahlt bis';
$language_text['_info_clankass_status_edited'] = 'Der Zahlstatus wurde erfolgreich gesetzt!';
## Shoutbox ##
$language_text['_shoutbox_head'] = 'Shoutbox';
$language_text['_error_empty_shout'] = 'Du musst einen Text in die Shoutbox eingeben!';
$language_text['_error_shout_saved'] = 'Dein Beitrag wurde erfolgreich in die Shoutbox eingetragen!';
$language_text['_shoutbox_archiv'] = 'Archiv';
$language_text['_shout_archiv_head'] = 'Shoutbox Archiv';
$language_text['_noch'] = 'noch';
$language_text['_zeichen'] = 'Zeichen';
## Misc ##
...
$language_text['_site_serverlist'] = 'Serverliste';
$language_text['_site_rankings'] = 'Rankings';
$language_text['_site_server'] = 'GameServer';
$language_text['_site_forum'] = 'Forum';
$language_text['_site_backup'] = 'Datenbankbackup';
...
$language_text['_site_banned'] = 'Bannliste';
$language_text['_site_gb'] = 'G&auml;stebuch';
$language_text['_site_clankasse'] = 'Clankasse';
$language_text['_site_clanwars'] = 'Clanwars';
$language_text['_site_upload'] = 'Upload';
$language_text['_site_taktiken'] = 'Taktiken';
...
$language_text['_site_gallery'] = 'Galerie';
...
$language_text['_rankings'] = 'Rankings';
$language_text['_gallery'] = 'Galerie';
$language_text['_news'] = 'News';
$language_text['_newsarchiv'] = 'Newsarchiv';
$language_text['_serverliste'] = 'Serverliste';
$language_text['_banned'] = 'Bannliste';
...
$language_text['_gb'] = 'G&auml;stebuch';
...
$language_text['_cnt'] = '#';
$language_text['_membergb'] = 'Profilg&auml;stebuch';
...
$language_text['_comment_added'] = 'Dein Kommentar wurde erfolgreich hinzugef&uuml;gt!';
...
$language_text['_site_contact'] = 'Kontaktformular';
$language_text['_site_joinus'] = 'JoinUs - Kontaktformular';
$language_text['_site_fightus'] = 'FightUs - Kontaktformular';
$language_text['_joinus'] = 'JoinUs';
$language_text['_fightus'] = 'FightUs';
...
$language_text['_ts_name'] = 'Servername';
$language_text['_ts_os'] = 'Betriebsystem';
$language_text['_ts_uptime'] = 'Uptime';
$language_text['_ts_channels'] = 'Channels';
$language_text['_ts_user'] = 'User';
$language_text['_ts_users_head'] = 'User Informationen';
$language_text['_ts_player'] = 'User';
$language_text['_ts_channel'] = 'Channel';
$language_text['_ts_logintime'] = 'Eingeloggt seit';
$language_text['_ts_idletime'] = 'AFK seit';
$language_text['_ts_channel_head'] = 'Channel Informationen';
$language_text['_taktik_choose'] = ' - Bitte w&auml;hlen - ';
$language_text['_config_tmpdir'] = 'Standardtemplate';
$language_text['_rankings_head'] = 'Rankings';
$language_text['_rankings_league'] = 'Liga';
$language_text['_rankings_place'] = 'Platz alt/neu';
$language_text['_rankings_admin_place'] = 'Platz';
$language_text['_rankings_squad'] = 'Team';
$language_text['_rankings_teamlink'] = 'Teamlink';
$language_text['_ranking_added'] = 'Das Ranking wurde erfolgreich hinzugef&uuml;gt!';
$language_text['_ranking_edited'] = 'Das Ranking wurde erfolgreich editiert!';
$language_text['_ranking_deleted'] = 'Das Ranking wurde erfolgreich gel&ouml;scht!';
$language_text['_ranking_empty_league'] = 'Du musst eine Liga angeben!';
$language_text['_ranking_empty_url'] = 'Du musst eine URL zu der Liga angeben!';
$language_text['_ranking_empty_rank'] = 'Du musst einen Rank angeben!';
$language_text['_rankings_add_head'] = 'Neues Ranking hinzuf&uuml;gen';
...
$language_text['_server_legendemenu'] = 'Server ist im Menu eingetragen? (aufs Icon klicken um Status zu &auml;ndern)<br />(Mehrfache Eintragungen sind m&ouml;glich!)';
$language_text['_config_c_servernavi'] = 'Menu: Serverstatus';
