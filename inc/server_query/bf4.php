    ...
    if ($request == 'info') {
        ...
        switch (cut_pascal($buffer, 4, 0, 1)) {
            ...
            case 'MP_Naval':
                ...
                break;
            case 'MP_Prison':
                $nmap = 'Operation Locker';
                break;
            case 'MP_Resort':
                $nmap = 'Hainan Resort';
                break;
            case 'MP_Siege':
                $nmap = 'Siege of Shanghai';
                break;
            case 'MP_TheDish':
                $nmap = 'Rogue Transmission';
                break;
            case 'MP_Tremors':
                $nmap = 'Dawnbreaker';
                break;
            // Second Assault Maps
            case 'XP0_Metro':
                $nmap = 'Operation Metro 2014';
                break;
            case 'XP0_Caspian':
                $nmap = 'Caspian Border 2014';
                break;
            case 'XP0_Oman':
                $nmap = 'Gulf of Oman 2014';
                break;
            case 'XP0_Firestorm':
                $nmap = 'Operation Firestorm 2014';
                break;
            // China Rising Maps
            case 'XP1_001':
                $nmap = 'Silk Road';
            ...
            case 'XP4_Titan':
                $nmap = 'Hangar 21';
                break;
            case 'XP4_WalkerFactory':
                $nmap = 'Giants of Karelia';
                break;
        }
        $data['mapname'] = $nmap;
