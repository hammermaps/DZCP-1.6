    ...
    if ($do == "anonym") {
        ...
        if ($get['t_reg'] == $userid || permission("forum")) {
            ...
            $index = show($dir . "/thread", array("titel" => _forum_edit_thread_head,
                ...
                "dowhat" => $dowhat,
                "error" => "",
                "posttopic" => h($get['topic']),
                "postsubtopic" => h($get['subtopic']),
                "postnick" => h($get['t_nick']),
        ...
        if ($get['t_reg'] == $userid || permission("forum")) {
            ...
            if ($toCheck) {
                ...
                $index = show($dir . "/thread", array("titel" => _forum_edit_thread_head,
                    ...
                    "posttopic" => htmlspecialchars($_POST['topic'], ENT_QUOTES, 'UTF-8'),
                    "postsubtopic" => htmlspecialchars($_POST['subtopic'], ENT_QUOTES, 'UTF-8'),
                    "error" => $error,
                    "admin" => $admin,
                    "vote" => $vote,
                    "eintraghead" => _eintrag));
