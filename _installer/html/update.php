<table width="100%" cellpadding="3" cellspacing="1">
    ...
    <tr>
        <td colspan="2" class="info"><b>Hinweis:</b> Bitte achten Sie darauf das Sie diesen Vorgang nur einmal abschlie&szlig;en,
            da sonst Sch&auml;den in der Datenbank auftreten k&ouml;nnten.<br/> <br/>
            Dieser Vorgang kann ggf. einige Sekunden dauern, achten Sie also bitte darauf, die Seite w&auml;hrend dessen
            nicht neu zu laden!
        </td>
    </tr>
    <tr>
