        ...
        <td>
            <form name="frm" action="" method="post">
                ...
                <table class="hperc" cellspacing="1">
                    <?php if ($ok) { ?>
                    <tr>
                        <td class="contentHead" colspan="2"><span
                                    class="fontBold">Channel: <?php echo rawurldecode($_GET['cName']) ?></span></td>
                    </tr>
                    <tr>
                            ...
                            <td colspan="2" class="contentMainTop">
                                <table class="hperc" cellspacing="0">
                                    <tr>
                                        <td width="1%">
                                            <?php if ($reg == "an" || $reg == "") { ?>
                                                <input type="radio" id="reg1" name="reg" value="an" checked="checked"
                                                       class="checkbox"/>
                                            <?php } else { ?>
                                        ...
                                        <td width="1%">
                                            ...
                                            <?php } else { ?>
                                                <input type="radio" id="reg2" name="reg" value="re" checked="checked"
                                                       class="checkbox"/>
                                            <?php } ?>
                                        </td>
                    ...
                    <?php }
                    if ($version == 2 || ($_GET['pw'] == 1 && $version == 3)) { ?>
                        <tr>
                    ...
                    <tr>
                        <td colspan="2" class="contentBottom">
                            <input id="tsSubmit" type="button" onClick="javascript:doSubmit();" value="Connect"
                                   class="submit"/>
                        </td>
                    </tr>
            </form>
