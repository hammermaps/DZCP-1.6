...
function seedDemoData(PDO $pdo): void
{
    ...
    $rows = [
        ...
        'dzcp_artikel' => [['id' => 2, 'autor' => '3', 'datum' => $now - 7200, 'kat' => 1, 'titel' => 'Leitfaden f&uuml;r Demo-Tests', 'text' => '<p>Artikel mit Beispielinhalt für die lokale Entwicklung.</p>', 'link1' => 'Startseite', 'url1' => '?page=news', 'link2' => '', 'url2' => '', 'link3' => '', 'url3' => '', 'public' => 1]],
        ...
        'dzcp_awards' => [['id' => 1, 'squad' => 2, 'date' => $now - 86400 * 14, 'postdate' => $now, 'event' => 'Demo Cup', 'place' => '1', 'prize' => 'Lokaler Testpokal', 'url' => 'https://example.test/demo-cup']],
        ...
        'dzcp_clankasse' => [['id' => 1, 'datum' => $now - 86400, 'member' => 'Demo Member', 'transaktion' => 'Serverbeitrag', 'pm' => 1, 'betrag' => 10.0]],
        'dzcp_clankasse_payed' => [['id' => 1, 'user' => 2, 'payed' => $now + 86400 * 30]],
